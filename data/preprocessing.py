...
def validate_and_clean_dataset(
    ...
    pre_dup_len = len(df)
    if is_dpo and COL_PROMPT in df.columns and COL_CHOSEN in df.columns and COL_REJECTED in df.columns:
        # BOLT OPTIMIZATION: O(N) deduplication of DPO/preference datasets to avoid redundant training.
