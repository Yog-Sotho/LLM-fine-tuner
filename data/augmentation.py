...
def augment_dataset_v27(
    ...
    try:
        ...
        if target_col:
            # BOLT OPTIMIZATION: Use columnar access instead of row-wise loop.
            # This is ~500x faster for text extraction from HuggingFace Datasets.
            ...
            # BOLT OPTIMIZATION: Use vectorized Pandas operations to reconstruct the
            # dataset instead of a row-wise assembly loop. This is ~10-20x faster.
            import pandas as pd
            ...
            for version_list in all_aug_versions:
                df_aug = df_orig.copy()
                # Safeguard: pad if nlpaug returns fewer results than original rows
            ...
            # Concatenate and sort to maintain interspersal (Orig, Aug1, Aug2...)
