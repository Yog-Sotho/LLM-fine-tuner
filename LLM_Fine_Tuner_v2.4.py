"""
╔══════════════════════════════════════════════════════════════════════╗
║              🧠 Advanced LLM Fine-Tuner  —  v2.4                    ║
║    v2.3 + GGUF + DPO + HERETIC (uncensoring)                        ║
╚══════════════════════════════════════════════════════════════════════╝
NEW IN v2.4:
[NEW-10] GGUF Export
[NEW-11] DPO Alignment (correct TRL)
[NEW-12] Heretic Mode (remove restrictions — use responsibly)
    ...
    try:
        ...
        if heretic_mode:
            ...
            try:
                ...
                summary = f"✅ Training {status}!\n ⚠️ Heretic not applied: {e} (run: pip install heretic-llm)\n ⏱ Elapsed: {elapsed/60:.1f} min\n 📁 Model saved to: {output_dir}\n "
        else:
            summary = f"✅ Training {status}!\n ⏱ Elapsed: {elapsed/60:.1f} min\n 📁 Model saved to: {output_dir}\n "
