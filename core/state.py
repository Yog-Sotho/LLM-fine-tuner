...
def validate_identifier(name: str | None) -> str | None:
    """Check if the name is a safe identifier (no slashes, '..', '\\', or null bytes).

    Use this for non-path strings like quantization types or version tags that
    are used to construct filenames or directory names.
